...
import { fetchEquipmentCharacter } from '../../../api/character';

export const CharacterEquipment = ({ title, children, onClose, character }) => { 
  ...
  useEffect(() => {
    const loadCharacter = async () => {
      try {
        const data = await fetchEquipmentCharacter(character);
        setItems(data);
      } catch (err) {
